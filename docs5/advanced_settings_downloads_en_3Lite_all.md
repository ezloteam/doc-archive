...
[Next](index.html#!docs5/reset_factory_defaults_en_3Lite_all.md)

Firmware Upgrades

  
Found under "Setup > Firmware". This tab shows you what version software is
currently installed in Vera , and what is the latest released version. If
there is a newer version of the software available, you will be able to
upgrade Vera. When you perform an upgrade, you have the option to preserve
Vera's current settings, so you don't have to change anything after the
upgrade. You can also simultaneously reset Vera to a default state so it is
running the newest software, but with the same factory setup Vera originally
shipped with.  
  
![](/images/mios/firmware.png)  
