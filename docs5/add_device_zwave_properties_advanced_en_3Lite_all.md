...
[Previous](index.html#!docs5/add_device_zwave_properties_options_en_3Lite_all.md)
[Next](index.html#!docs5/add_device_zwave_properties_dev_option_en_3Lite_all.md)

Advanced

  
The options that are found here aren't used by many users and you shouldn't
changed them if you don't know what are you doing.  
  
  
![](/images/mios/UI5_AdvTabPart1.PNG)  
  
  
  
![](/images/mios/UI5_AdvTabPart2.PNG)  
  
  
If you check "hidden" the device won't appear anymore on the Desktop.  
  
Name: The name that will appear above the device icon on the desktop.  
  
Device_Type:  The upnp service that this device implements.  
  
Device_File: The implementation file that describes the upnp service
associated to this device.  
  
Capabilities: show the capabilities reported by the zwave device  
